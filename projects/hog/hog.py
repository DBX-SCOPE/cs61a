...
def is_always_roll(strategy, goal=GOAL):
    ...
    for score in range(goal):
        for opponent_score in range(goal):
            ...
            elif roll != strategy(score, opponent_score):
                return False
    return True
    # END PROBLEM 7
...
def make_averaged(original_function, times_called=1000):
    ...
    def average(*args):
        ...
        average_result = result / times_called
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    sus_boar_result = sus_update(0, score, opponent_score, dice=six_sided)
    normal_result = score + threshold
    if sus_boar_result >= normal_result:
        return 0
    return num_rolls
    # END PROBLEM 11
